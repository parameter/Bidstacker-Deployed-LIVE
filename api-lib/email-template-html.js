    ...
    return (`<div style="max-width: 600px; padding: 20px; background: #FFFFFF; border-radius: 5px; margin: 40px auto; font-family: Open Sans,Helvetica,Arial; font-size: 15px; color: #666;">
        <div style="color: #444444; font-weight: normal;">
            <div style=" padding: 10px 0; border-bottom: solid 3px #EEEEEE;">
                ...
                <div style="position: relative; padding-top: 33px; padding-left:62px; background-repeat: no-repeat; width:100%; min-height:100px; background-image:url(${assets_domain}/html-email-assets/header-angle.jpg); background-position: bottom; background-size: 100% auto;">
