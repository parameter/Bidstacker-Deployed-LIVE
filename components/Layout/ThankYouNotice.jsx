...
const ThankYouNotice = ({ sending }) => {
    ...
    return (<div className="absolute left-0 top-0 w-full h-full bg-[#282623a0] z-20">
           <div className="absolute py-6 px-6 left-[50%] top-[50%] bg-white -translate-x-1/2 -translate-y-1/2 animated_neon_gradient rounded-3xl">
            <div className="relative px-12 py-8 left-0 top-0 bg-white w-full min-h-[330px] min-w-[640px] rounded-xl">
